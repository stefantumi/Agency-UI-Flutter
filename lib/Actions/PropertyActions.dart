...
Future<Property> createProperty(Property newProperty) async {
  Uri url = Uri.parse("https://localhost:7210/api/property");
...
Future<List<Property>> getPropertyList() async {
  var response = await http.get(Uri.parse("https://localhost:7210/api/property"));
...
Future<Property> getPropertyById(int id) async {
  var response = await http.get(Uri.parse("https://localhost:7210/api/property/$id"));
  if(response.statusCode == 200 || response.statusCode == 201){
    return Property.fromJson(jsonDecode(response.body));
  }else{
...
Future<http.BaseResponse> updatePropertyById(int id, String newName) async {
  var url = Uri.parse("https://localhost:7210/api/Property/$id");
...
Future<http.BaseResponse> deletePropertyById(int id) async {
  var response = await http.delete(Uri.parse("https://localhost:7210/api/property/$id"));
